def train_go1(headless=True):
    ...
    Cfg.domain_rand.randomize_gravity = False      # Close DR
    ...
    Cfg.domain_rand.randomize_ground_friction = False   # Close DR
    ...
    env = FrontFeetHeightTrackingEnv(sim_device='cuda:0', headless=headless, cfg=Cfg)
